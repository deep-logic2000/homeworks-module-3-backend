...
import com.example.homework_module3.Homework01.DAO.CustomerDaoImpl;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public void deleteAccount (Long customerId, Long accountId) {
        ...
        boolean isAccountDeletedSuccess = accountDao.deleteById(accountId);
        if (!isAccountDeletedSuccess) {
            throw new RuntimeException("Account haven't been deleted.");
        }
