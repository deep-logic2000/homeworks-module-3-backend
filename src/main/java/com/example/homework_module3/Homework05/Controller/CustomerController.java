...
import com.example.homework_module3.Homework05.Service.CustomerServiceImpl;
import com.example.homework_module3.Homework05.Service.mappers.AccountDtoMapperRequest;
import com.example.homework_module3.Homework05.Service.mappers.AccountDtoMapperResponse;
import com.example.homework_module3.Homework05.Service.mappers.CustomerDtoMapperRequest;
import com.example.homework_module3.Homework05.Service.mappers.CustomerDtoMapperResponse;
...
import com.example.homework_module3.Homework05.domain.dto.*;
...
public class CustomerController {
    ...
    public ResponseEntity<?> getAll(@RequestParam(defaultValue = "0") int pageNumber,
        ...
        log.info("getAll method in CustomerController is triggered.");
    ...
    public ResponseEntity<?> getById(@PathVariable Long id) {
        log.info("getById method in CustomerController is triggered.");
    ...
    public ResponseEntity<?> createCustomer(@Valid @RequestBody CustomerDtoRequest customer) {
        log.info("createCustomer method in CustomerController is triggered.");
        ...
        try {
            ...
            log.error("Error during create customer: ", e);
    ...
    public ResponseEntity<?> updateCustomer(@PathVariable Long id, @Valid @RequestBody CustomerDtoRequest customerDtoRequest) {
        log.info("updateCustomer method in CustomerController is triggered.");
    ...
    public ResponseEntity<?> deleteCustomer(@PathVariable Long id) {
        log.info("deleteCustomer method in CustomerController is triggered.");
        try {
    ...
    public ResponseEntity<?> createAccount(@PathVariable Long id, @Valid @RequestBody AccountDtoRequest accountDto) {
        log.info("createAccount method in CustomerController is triggered.");
        try {
    ...
    public ResponseEntity<?> deleteAccount(@PathVariable Long id, @PathVariable Long accountId) {
        log.info("deleteAccount method in CustomerController is triggered.");
        try {
            customerServiceImpl.deleteAccount(id, accountId);
            accountServiceImpl.changeAccountStatus(accountId, "was deleted");
            return ResponseEntity.ok("Account deleted successfully.");
        } catch (IllegalArgumentException e) {
            log.warn("Account with id {} not found", accountId, e);
            return ResponseEntity.badRequest().body(e.getMessage());
        }
    }
